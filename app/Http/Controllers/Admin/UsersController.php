...
class UsersController extends JoshController
{
        ...
        return DataTables::of(User::query())
            ...
            ->addColumn('actions',function($user) {
                ...
                if ((Sentinel::getUser()->id != $user->id) && ($user->id != 1)) {
                   // $actions .= '<a href='. route('admin.users.confirm-delete', $user->id) .' data-toggle="modal" data-target="#"><i class="livicon" data-name="user-remove" data-size="18" data-loop="true" data-c="#f56954" data-hc="#f56954" title="delete user"></i></a>';
    ...
    public function store(UserRequest $request)
    {
        ...
        //check whether user should be activated by default or not
