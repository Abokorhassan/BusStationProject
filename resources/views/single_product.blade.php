...
@section('content')
    ...
    <div class="container">
            ...
            <div class="mart10">
                ...
                <div class="col-md-4 right_float">
                    ...
                    <div class="row">
                        ...
                        <div id="gal1">
                            <a class="float_right" href="#" data-image="{{ asset('assets/images/cart/small/1.jpg') }}" data-zoom-image="{{ asset('assets/images/cart/big/1.jpg') }}">
                                <img id="img_01" src="{{ asset('assets/images/cart/small/1.jpg') }}" class="img-responsive" />
                            </a>
                            <a class="float_right" href="#" data-image="{{ asset('assets/images/cart/small/2.jpg') }}" data-zoom-image="{{ asset('assets/images/cart/big/2.jpg') }}">
                                <img id="img_01" src="{{ asset('assets/images/cart/small/2.jpg') }}" class="img-responsive" />
                            </a>
                            <a class="float_right" href="#" data-image="{{ asset('assets/images/cart/small/3.jpg') }}" data-zoom-image="{{ asset('assets/images/cart/big/3.jpg') }}">
                                <img id="img_01" src="{{ asset('assets/images/cart/small/3.jpg') }}" class="img-responsive" />
                            </a>
                            <a class="float_right" href="#" data-image="{{ asset('assets/images/cart/small/4.jpg') }}" data-zoom-image="{{ asset('assets/images/cart/big/4.jpg') }}">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="tab_default_2">
                                <div class="row">
                                    ...
                                    <div class="col-sm-8 right_float">
                                        ...
                                        <strong>Trout Burrowing</strong>
                                        <p>Burbot yellow-eye mullet sailback scorpionfish sandroller snake mudhead limia sea chub Asiatic glassfish marblefish pikehead snook. Atlantic eel Rio Grande perch stingray longjaw mudsucker albacore northern sea robin spotted dogfish northern sea robin river stingray. </p>
                                        <nav class="pull-right left_float">
                                            <ul class="pagination">
        ...
        <div class="row">
            ...
            <div class="flip-3d right_float">
                <figure>
                    <img src="{{ asset('assets/images/cart/default/saree1.jpg') }}" alt="product image">
                    <figcaption>
                        <h4 class="text-white prod_tabs1">Floral Printed Saree</h4>
                        <ul class="text-white prod_tabs1">
                            <li>Product Type - Women's Saree</li>
                            <li>Color - Multi Colour</li>
                        </ul>
                        <h4 class="text-white prod_tabs1"><del class="text-danger">Rs. 1599.00</del>  Rs. 1198.00   </h4>
                    </figcaption>
                </figure>
            </div>
            <div class="flip-3d right_float">
                <figure>
                    ...
                    <figcaption>
                        <h4 class="text-white prod_tabs1">Atelier Check Shirt</h4>
                        <ul class="text-white prod_tabs1">
                            <li>Product -Men's Club Wear</li>
                            <li>Care - Machine/Hand Wash</li>
                        </ul>
                        <h4 class="text-white prod_tabs1"><del class="text-danger">Rs. 1999.00</del> Rs. 1499.00</h4>
                    </figcaption>
                </figure>
            </div>
            <div class="flip-3d right_float">
                <figure>
                    ...
                    <figcaption>
                        <h4 class="text-white prod_tabs1">Sony Xperia C3 - (Black)</h4>
                        <ul class="text-white prod_tabs1">
                            <li>Android v4.4.2 (KitKat)</li>
                            <li>Quad-core 1.2 GHz</li>
                        </ul>
                        <h4 class="text-white prod_tabs1"><del class="text-danger">Rs. 21,990</del>  Rs. 18,088</h4>
                    </figcaption>
                </figure>
            </div>
            <div class="flip-3d right_float">
                <figure>
                    ...
                    <figcaption>
                        <h4 class="text-white prod_tabs1">Samsung Galaxy S6 64 GB - (White)</h4>
                        <ul class="text-white prod_tabs1">
                            <li>Android v4.4.2 (KitKat)</li>
                            <li>Quad-core 1.2 GHz</li>
                        </ul>
                        <h4 class="text-white prod_tabs1">Rs. 55,900</h4>
                    </figcaption>
                </figure>
            </div>
        </div>
