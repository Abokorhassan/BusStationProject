          ...
          <div class="row margin_right_left">
            <div class="col-md-12">
              ...
              <div class="position-center">
                <div class="row">
                  <div class="col-sm-8">
                    {!! Form::model($busstop, ['url' => URL::to('busstop/' . $busstop->id), 'method' => 'put',
                      ...
                      <div class="form-group {{ $errors->first('bstop_num', 'has-error') }}">
                        <label for="bstop_num" class="col-sm-2 control-label">
                          <strong>Bus Stop No.*</strong> 
                        </label>
                        <div class="col-sm-10">
                          {!! Form::text('bstop_num', $busstop->bstop_num, array('class' => 'form-control required', 'placeholder'=>'Name')) !!}
                      ...
                      <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-4 btn_rtl">
                            <a href="{{ route('user.busstop.index') }}">
