                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="{{ URL::to('admin/draft') }}">
                                        <i class="livicon draft_icon" data-n="unlink" data-s="16" data-c="gray"></i>
                                        &nbsp; &nbsp; <span class="draft"> Draft (10)</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
                                    ...
                                    <tr>
                                        <th colspan="6">
                                            <div class="row no-padding">
                                                <div class="col-md-9 col-lg-9 col-xs-12 animate_rtl">
                                                    <div class="btn-group pull-left table-bordered paddingrightleft_10 paddingtopbottom_5px animate_rtl">
                                                    ...
                                                    <div class="btn-group pull-left table-bordered paddingrightleft_10 paddingtopbottom_5px margin_left animate_rtl">
                                                        <i class="livicon" data-n="refresh" data-s="17"></i>
                                                    </div>
                                                </div>
                                                <div class="col-md-3 col-lg-3 col-xs-12 animate_rtl">
