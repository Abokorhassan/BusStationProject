                    ...
                    <form id="commentForm" action="{{ route('admin.users.store') }}"
                      ...
                      <div id="rootwizard">
                        <ul>
                          ...
                          <li>
                            <a href="#tab2" data-toggle="tab">Bio
                            </a>
                          </li>
                          <li>
                        ...
                        <div class="tab-content">
                          ...
                          <div class="tab-pane" id="tab2" disabled="disabled">
                            ...
                            <div class="form-group {{ $errors->first('pic_file', 'has-error') }}">
                              <label for="pic" class="col-sm-2 control-label">Profile picture
                              </label>
                              <div class="col-sm-10">
                          ...
                          <div class="tab-pane" id="tab4" class="last_tab" disabled="disabled">
                            ...
                            <div class="form-group required">
                              <label for="group" class="col-sm-2 control-label right_label">Group *
                              </label>
                              <div class="col-sm-10">
                              ...
                              <span class="help-block">{{ $errors->first('group', ':message') }}
                              </span>
                            </div>
                            <div class="form-group">
                              <label for="activate" class="col-sm-2 control-label right_label"> Activate User *
                              </label>
                              <div class="col-sm-10">
                                ...
                                <span>To activate user account automatically, click the check box
                                </span>
                              </div>
                            </div>
                          </div>
