            ...
            <div class="col-md-6 animate_rtl">
                ...
                <div class="panel panel-primary" id="hidepanel1">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal basic1" action="#">
                            <!-- CSRF Token -->
                                <!-- Name input-->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 form1_basic">
                                ...
                                <div class="form-position">
                                    <div class="col-md-12 text-right">
                                        <button type="submit" class="btn btn-responsive btn-primary btn-sm left_btn">Submit</button>
                                    </div>
                                </div>
                        </form>
                    </div>
                ...
                <div class="panel panel-info" id="hidepanel2">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal basic2" action="#" method="">
                            <!-- CSRF Token -->
                            ...
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <div class="col-md-12 text-right">
                                        <button type="submit" class="btn btn-responsive btn-info btn-sm left_btn" id="basic_form">Sign in</button>
                                    </div>
                                </div>
                            </fieldset>
                        </form>
