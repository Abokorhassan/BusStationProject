                ...
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        <form method="get" name="frmOnline" id='form_validation' onsubmit="return Validation()" enctype="multipart/form-data" action="#">
                            <div class="row">
                                <div class="col-xs-12 col-sm-6 col-md-6 animate_rtl">
                                    <div class="form-group">
                ...
                <div class="panel panel-success">
                    ...
                    <div class="panel-body">
                        <form method="post" id="passwordForm">
                            ...
                            <div class="row">
                                <div class="col-sm-6 padding animate_rtl">
                ...
                <div class="panel panel-danger">
                    ...
                    <div class="panel-body">
                        <form id="tryitForm" class="form-horizontal">
                            <div class="form-group">
                                <label class="col-md-3 col-xs-12 control-label animate_rtl">Full name</label>
                                <div class="col-md-4 col-xs-6 col-sm-6 animate_rtl">
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label animate_rtl">Email Address</label>
                                <div class="col-md-8 animate_rtl">
                                    <input type="text" class="form-control " name="email" placeholder="Enter Email Address" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-3 control-label animate_rtl">Gender</label>
                                <div class="col-md-6 animate_rtl">
