        ...
        <div class="row">
            <div class="col-md-6 animate_rtl">
                <div class="panel panel-info">
                    ...
                    <div class="panel-body right_btn">
                        <div class="text-left">
        ...
        <div class="row">
            ...
            <div class="col-md-6 animate_rtl">
                ...
                <div class="panel  panel-default">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-12 col-lg-6 col-xs-12 col-sm-12 animate_rtl">
            ...
            <div class="col-md-6 animate_rtl">
                ...
                <div class="panel panel-success">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-xs-6 col-md-6 animate_rtl">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-12 text-center">
                                ...
                                <br/>
                                <div class="ui-group-buttons">
                                    <button type="button" class="btn btn-primary btn-xs animate_rtl">Extra small button</button>
                                    <div class="or or-xs animate_rtl"></div>
                ...
                <div class="panel panel-warning">
                    ...
                    <div class="panel-body icon-buttons">
                        ...
                        <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6 buttons_labels animate_rtl">
                            <button type="button" class="btn btn-labeled btn-success">
                                        <span class="btn-label pull-left animate_rtl">
                        ...
                        <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6 animate_rtl">
                            ...
                            <button type="button" class="btn btn-labeled btn-default btn-icon-right right_lable btn_padding">
                                ...
                                <span class="btn-label pull-left cool_right animate_rtl">
            ...
            <div class="row">
                <div class="panel panel-danger">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <!--start-->
                            <div class="col-sm-4 social-buttons animate_rtl">
                                <h3>The Buttons</h3>
