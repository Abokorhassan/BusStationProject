...
<section class="content">
    ...
    <div class="row">
        <div class="col-md-6 col-sm-6 col-xs-12 animate_rtl">
                    ...
                    <div class="box-body">
                        <dl class="dl-horizontal">
                           <dt>Description lists</dt>
                            <dd  class="left_float">A description list is perfect for defining terms.</dd>
                           <dt>Question</dt>
                            <dd class="left_float">
                                Vestibulum id ligula porta felis euismod semper eget lacinia odio sem nec elit.
                            </dd>
                            <dd class="left_float">Donec id elit non mi porta gravida at eget metus.</dd>
                           <dt>Progress bar</dt>
                            <dd class="left_float">Etiam porta sem malesuada magna mollis euismod.</dd>
                            <dt>Answer</dt>
                            <dd class="left_float">
    ...
    <div class="row">
        <div class="col-md-4 col-sm-4 col-xs-12 animate_rtl">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title">
            ...
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    <div class="box-body">
                        ...
                        <div class="col-md-6">
                            <div class="bs-component animate_rtl">
