                            ...
                            <div class="row">
                                <div class="col-md-4 col-md-offset-4">
                                    ...
                                    <div> <b class="margin_right15"> {{$min_id}} </b>
                                        <input id="id_range" type="text" data-slider-id='id_range' class="slider form-control" data-slider-handle="square" value="" data-slider-min="{{$min_id}}" data-slider-max="{{$max_id}}" data-slider-step="1" data-slider-value="[{{$min_id}},{{$max_id}}]"/> <b class="margin_left15">@if(!empty($max_count)){{$max_id}} @else 10 @endif</b>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="panel panel-primary filterable">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div> <b class="margin_right15">{{$min_id}}</b>
                                            <input id="id_range2" type="text" data-slider-id='id_range' class="slider form-control" dusk="slide_range" data-slider-handle="square" value="" data-slider-min="{{$min_id}}" data-slider-max="{{$max_id}}" data-slider-step="1" data-slider-value="[{{$min_id}},{{$max_id}}]"/> <b class="margin_left15">@if(!empty($max_count)){{$max_id}} @else 10 @endif</b>
                                        </div>
                                    </div>
