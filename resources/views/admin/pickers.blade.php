    ...
    <div class="row">
        ...
        <div class="col-md-6 animate_rtl">
            ...
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    <!--switch -->
                    <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12 animate_rtl">
                        <div class="spinners">
                            <label>Quality</label>
                    ...
                    <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12 animate_rtl">
                        ...
                        <p>
                            <span class="values">  Old = </span> <span id="old-val" class="values"></span><span class="values"> , </span><span class="values"> New = </span> <span id="new-val" class="values"></span>
                        </p>
                    </div>
                    <!--switch -->
                    <div class="spinners">
