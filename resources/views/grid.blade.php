        ...
        <div class="row">
            ...
            <form class="grid">
                <div class="form-group row">
                    <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1 form_padding right_float">
                        <input class="form-control" placeholder=".col-lg-1" type="text">
                    </div>
                    <!-- /.col-lg-1 -->
                    <div class="col-lg-11 col-md-11 col-sm-11 col-xs-11 right_float">
                        <input class="form-control" placeholder=".col-lg-11" type="text">
                    </div>
                    <!-- /.col-lg-11 -->
                </div>
                <div class="form-group row">
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 right_float">
                        <input class="form-control" placeholder=".col-lg-2" type="text">
                    </div>
                    <!-- /.col-lg-2 -->
                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 right_float">
                        <input class="form-control" placeholder=".col-lg-10" type="text">
                    </div>
                    <!-- /.col-lg-10 -->
                </div>
                <div class="form-group row">
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 right_float">
                        <input class="form-control" placeholder=".col-lg-3" type="text">
                    </div>
                    <!-- /.col-lg-3 -->
                    <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 right_float">
                        <input class="form-control" placeholder=".col-lg-9" type="text">
                    </div>
                    <!-- /.col-lg-9 -->
                </div>
                <div class="form-group row">
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 right_float">
                        <input class="form-control" placeholder=".col-lg-4" type="text">
                    </div>
                    <!-- /.col-lg-4 -->
                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 right_float">
                        <input class="form-control" placeholder=".col-lg-8" type="text">
                    </div>
                    <!-- /.col-lg-8 -->
                </div>
                <div class="form-group row">
                    <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5 right_float">
                        <input class="form-control" placeholder=".col-lg-5" type="text">
                    </div>
                    <!-- /.col-lg-5 -->
                    <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7 right_float">
                        <input class="form-control" placeholder=".col-lg-7" type="text">
                    </div>
                    <!-- /.col-lg-7 -->
                </div>
                <div class="form-group row">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 right_float">
            ...
            <div class="col-md-12 ">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body" id="slim1">
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-1 col-sm-2 col-xs-5 text-center bar-primary lg-grid right_float">
                            ...
                            <div class="col-lg-4 col-md-5 col-sm-4 col-xs-4 text-center bar-success lg-grid right_float">
                                <span class="visible-lg">.col-lg-4</span>
                                <span class="visible-md">.col-md-5</span>
                                <span class="visible-sm">.col-sm-4</span>
                                <span class="visible-xs">.col-xs-4</span>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-3 text-center bar-danger lg-grid right_float">
                                <span class="visible-lg">.col-lg-4</span>
                        ...
                        <div class="row">
                            <h3>xs Grid</h3>
                            <div class="col-xs-5 text-center bar-primary right_float">
                                <p>.col-xs-5</p>
                            </div>
                            <div class="col-xs-4 text-center bar-success right_float">
                                <p>.col-xs-4</p>
                            </div>
                            <div class="col-xs-3 text-center bar-danger right_float">
                                <p>.col-xs-3</p>
                            </div>
                        </div>
                        <!-- end row -->
                        <div class="row">
                            <h3>sm Grid</h3>
                            <div class="col-sm-2 text-center bar-primary right_float">
                                <p>.col-sm-2</p>
                            </div>
                            <div class="col-sm-4 text-center bar-success right_float">
                                <p>.col-sm-4</p>
                            </div>
                            <div class="col-sm-6 text-center bar-danger right_float">
                                <p>.col-sm-6</p>
                            </div>
                        </div>
                        <!-- end row -->
                        <div class="row">
                            ...
                            <div class="col-md-1 text-center bar-primary right_float">
                                <p>.col-md-1</p>
                            </div>
                            <div class="col-md-5 text-center bar-success right_float">
                                <p>.col-md-5</p>
                            </div>
                            <div class="col-md-6 text-center bar-danger right_float">
                                <p>.col-md-6</p>
                            </div>
                        </div>
                        <!-- end row -->
                        <div class="row">
                            <h3>lg Grid</h3>
                            <div class="col-lg-4 text-center bar-primary right_float">
                                <p>.col-lg-4</p>
                            </div>
                            <div class="col-lg-4 text-center bar-success right_float">
                                <p>.col-lg-4</p>
                            </div>
                            <div class="col-lg-4 text-center bar-danger right_float">
                                <p>.col-lg-4</p>
                            </div>
                        </div>
                        <!-- end row -->
