...
@section('top')
    <div class="breadcum">
        <div class="container">
            ...
            <div class="pull-right left_float">
        ...
        <div class="row">
            <div class="content">
                <div class="col-md-8 right_float">
                    ...
                    <div class="featured-post-wide thumbnail">
                        ...
                        <div class="featured-text relative-left">
                            <h3 class="primary"><a href="#">{{$test->id}}</a></h3>
                            <p>
                                {!! $test->email !!}
                            </p>
                            <p>
                            ...
                            <p class="additional-post-wrap">
                                <span class="additional-post">
                                    <i class="livicon" data-name="user" data-size="13" data-loop="true" data-c="#5bc0de" data-hc="#5bc0de"></i> by &nbsp;<a href="#">{{$test->first_name}}</a>
                                </span>
                                <span class="additional-post">
                                    <i class="livicon" data-name="clock" data-size="13" data-loop="true" data-c="#5bc0de" data-hc="#5bc0de"></i><a href="#"> {{$test->created_at->diffForHumans()}}</a>
                                </span>
                                <span class="additional-post">
                                    <i class="livicon" data-name="comment" data-size="13" data-loop="true" data-c="#5bc0de" data-hc="#5bc0de"></i><a href="#">  First name</a>
                                </span>
                            </p>
                            <hr>
                ...
                <div class="col-md-4 right_float">
                    ...
                    <div class="tabbable-panel">
                        ...
                        <div class="tabbable-line">
                            ...
                            <ul class="nav nav-tabs tabs_content">
                                ...
                                {{-- popular post modal link --}}
                                <li class="active">
                                    <a href="#tab_default_1" data-toggle="tab">
                                        Popular Posts </a>
                                </li>

                                 {{-- Recent post modal link --}}
                                <li>
                    ...
                    {{-- recenet comment rith buttom edge --}}
            ...
            <div class="well">
             <div class="row"> --}}
                    {{-- <div class="col-md-4 col-sm-4">
                        <img style="width:100%" src="/flaravel/public/storage/cover_images/{{$post->cover_image}}" alt="no">
                    </div> --}}
                    {{-- <div class="col-md-8 col-sm-8">
                        <a href="#"><h4>{{$test->email}}</h4></a>
                        <small>written on {{$test->created_at}} by {{$test->first_name}}</small>
                    </div>
                </div>
            </div>          
        @endforeach --}}
