                ...
                <div class="row margin_right_left">
                  <div class="col-md-12">
                    ...
                    <div class="position-center">
                      ...
                      <div>
                        <h3 class="text-primary" id="title">Personal Information
                        </h3>
                      </div>
                        ...
                        <div class="col-md-10">
                          <div class="fileinput fileinput-new" data-provides="fileinput">
                            ...
                            <div>
                              ...
                              <span class="btn btn-primary fileinput-exists" data-dismiss="fileinput">Remove
                              </span>
                            </div>
                          </div>
                          <span class="help-block">{{ $errors->first('pic', ':message') }}
                          </span>
                        </div>
                      </div>
