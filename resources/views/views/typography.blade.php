    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4 right_float">
                <h3>Texts</h3>
                <div class="pull-right">
                    <ul class="list-unstyled tabs_content">
        ...
        <div class="row">
            ...
            <div class="col-md-8 right_float">
                ...
                <h4 class="text-left right_align"><b>Left aligned text.</b></h4>
                <p class="text-left right_align">Wouldn't you like to get away? Sometimes you want to go where everybody knows your name. </p>
                ...
                <h4 class="text-right left_align"><b>Right aligned text.</b></h4>
                <p class="text-right left_align">Wouldn't you like to get away? Sometimes you want to go where everybody knows your name.</p>
