        ...
        <div class="row">
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            @if(($percents))
                                <div class="col-lg-3 col-sm-5 animate_rtl">
                                    <canvas id="stats-doughnut-chart" height="300px" width="300px"></canvas>
                                </div>
                                <div class="col-lg-9  col-sm-7 animate_rtl">
                                    <section class="box-body">
                                        <div class="row">
                                            @foreach($percents as $level => $item)
                                                <div class="col-lg-4 col-md-12 animate_rtl">
