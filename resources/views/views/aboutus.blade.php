...
@section('content')
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-7 col-sm-12 wow bounceInLeft right_float" data-wow-duration="5s">
            ...
            <!-- Slider Start -->
            <div class="col-md-5 col-sm-12 slider wow fadeInRightBig right_float" data-wow-duration="5s">
        ...
        <div class="row">
            ...
            <!-- left Section Start -->
            <div class="col-md-6 col-sm-12 right_float">
                <!-- Responsive Section Start -->
                <div class="col-sm-6 col-md-6 wow zoomIn right_float" data-wow-duration="3s">
                    <div class="box">
                        <div class="box-icon">
