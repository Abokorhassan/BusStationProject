...
@section('content')
    ...
    <div class="container">
        <div class="row details">
            ...
            <div class="col-md-6 wow bounceInLeft right_float" data-wow-duration="1.5s">
            ...
            <div class="col-md-6 wow bounceInRight right_float" data-wow-duration="1.5s">
                ...
                <ul style="padding: 0 0 0 10px;">
                    <li><b class="right_float">Category:</b>&nbsp;Web Template</li>
                    <br />
                    <li><b class="right_float">Client:</b>&nbsp;Leda B. Powers</li>
                    <br />
                    <li><b class="right_float">Tags:</b>&nbsp;Web, PHP</li>
                    <br />
                    <li><b class="right_float"> Link:</b><a href="#">&nbsp;www.domain.com</a></li>
                    <br />
