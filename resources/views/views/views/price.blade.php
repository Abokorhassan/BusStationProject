...
@section('content')
    ...
    <div class="container">
        <div class="row">
            <h2 id="pricing_tables_title" class="panel_heading"> PRICING TABLES</h2>
            <!-- Vestibulizzle Section Start -->
            <div class="col-md-3 col-sm-6 wow flipInY right_float" data-wow-duration="3.5s">
            ...
            <div class="col-md-3 col-sm-6 wow flipInY right_float" data-wow-duration="3s" data-wow-delay="0.7s">
                <div class="panel panel-default text-center">
                    <div class="panel-heading">
            ...
            <div class="col-md-3 col-sm-6 wow flipInY right_float" data-wow-duration="3s" data-wow-delay="1.2s">
                <div class="panel panel-default text-center">
                    <div class="panel-heading">
            ...
            <div class="col-md-3 col-sm-6 wow flipInY right_float" data-wow-duration="3s" data-wow-delay="1.6s">
                <div class="panel panel-default text-center">
                    <div class="panel-heading">
