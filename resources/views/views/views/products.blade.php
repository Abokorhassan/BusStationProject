...
@section('content')
    ...
    <div class="container">
        ...
        <div class="row">
            <h3 id="title" class="panel_heading">BEST DEALS</h3>
            <div class="col-sm-6 col-md-3 wow flipInX right_float" data-wow-duration="3.5s">
            ...
            <div class="col-sm-6 col-md-3 wow flipInX right_float" data-wow-duration="3s" data-wow-delay="0.5s">
                <div class=" thumbnail text-center">
            ...
            <div class="col-sm-6 col-md-3 wow flipInX right_float" data-wow-duration="3s" data-wow-delay="0.9s">
                <div class=" thumbnail text-center">
            ...
            <div class="col-sm-6 col-md-3 wow flipInX right_float" data-wow-duration="3s" data-wow-delay="1.4s">
                <div class=" thumbnail text-center">
            ...
            <nav>
                <ul class="pagination pull-right left_paginate">
        ...
        <div class="row">
            <h3 id="title" class="panel_heading">NEW LAUNCHES </h3>
            <div class="col-sm-6 col-md-3 wow flipInX right_float" data-wow-duration="3.5s">
                <div class="thumbnail text-center">
        ...
        <div class="row">
            <h3 id="title" class="panel_heading">WOMENS </h3>
            <div class="col-sm-6 col-md-3 wow flipInX right_float" data-wow-duration="3.5s">
                <div class="thumbnail text-center">
            ...
            <h5><a href="{{ URL::to('category') }}" class="more_items">More items</a></h5>

        </div>
        <!-- //Womens Section End -->
        <!-- Mens Section Start -->
        <div class="row">
            <h3 id="title" class="panel_heading">MENS </h3>
            <div class="col-sm-6 col-md-3 wow flipInX right_float" data-wow-duration="3.5s">
                <div class="thumbnail text-center">
