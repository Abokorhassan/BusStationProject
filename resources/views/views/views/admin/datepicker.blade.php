    ...
    <div class="row">
                        ...
                        <div class="col-lg-6 animate_rtl">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control borders" id="datetime1"/>
                                </div>
                                <!-- /.input group -->
                            </div>
                            <div class="form-group ">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control borders" id="datetime2"/>
                                </div>
                                <!-- /.input group -->
                            </div>
                            <div class="form-group ">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control borders" id="datetime3"/>
                                </div>
                                <!-- /.input group -->
                            </div>
                            <div class="form-group ">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control borders" id="datetime4"/>
                                </div>
                                <!-- /.input group -->
                            </div>
                        </div>
        ...
        <div class="col-md-6 animate_rtl">
            <div class="panel panel-primary">
                ...
                <div class="panel-body sizing daterange">
                    <div class="box-body">
                        <!-- Date dd/mm/yyyy -->
                        <div class="form-group">
                            <label>
