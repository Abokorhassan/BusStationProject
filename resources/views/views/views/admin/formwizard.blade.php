                            ...
                            <div class="tab-content wizards">
                                ...
                                <div class="tab-pane" id="tab2">
                                    ...
                                    {{--<div class="form-group">--}}
                                        ...
                                        {{--<input id="name" name="fname" placeholder="Enter your First name" type="text" class="form-control required" data-bv-field="fname">--}}
                                        {{--<small class="help-block" data-bv-validator="notEmpty" data-bv-for="fname" data-bv-result="NOT_VALIDATED" style="display: none;">The first name is required </small>--}}
                                    {{--</div>--}}
                                    <div class="form-group">
                                        <label for="name" class="control-label">First name *</label>
                                ...
                                <ul class="pager wizard wiz_padng">
                                    <li class="previous">
                                        <a href="#">Previous</a>
                                    </li>
                                    <li class="next">
