            ...
            <div class="col-md-12">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-3 animate_rtl">
                                <h3>
                            ...
                            <div class="col-md-3 animate_rtl colors">
                                <h3>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <div class="footer_div">
                                <button type="button" data-dismiss="modal" class="btn btn-default def_btn">Close</button>
                                <button type="button" class="btn btn-primary prim_btn">Save changes</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <div class="footer_div">
                                <button type="button" data-dismiss="modal" class="btn btn-default def_btn">Close</button>
                                <button type="button" class="btn btn-primary prim_btn">Ok</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal fade in" id="ajax-modal" tabindex="-1" role="dialog" aria-hidden="false">
                <div class="modal-dialog modal-sm">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <ul class="nav nav-tabs ajax_modal">
                                <li class="active animate_rtl">
                                    <a href="#tab1" data-toggle="tab">Tab 1</a>
                                </li>
                                <li class="animate_rtl">
            ...
            <div class="modal fade in" id="static" tabindex="-1" role="dialog" aria-hidden="false">
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <div class="footer_div">
                            <button type="button" data-dismiss="modal" class="btn btn-default def_btn">Cancel</button>
                            <button type="button" data-dismiss="modal" class="btn btn-primary prim_btn">Continue Task</button>
                            </div>
                        </div>
                    </div>
                </div>
