            ...
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    <div class="btn-group btn-group-lg">
                        <button type="button" class="btn btn-primary btn_sizes animate_rtl">Button 1</button>
                        <button type="button" class="btn btn-success btn_sizes animate_rtl">Button 2</button>
                        <button type="button" class="btn btn-danger btn_sizes animate_rtl">Button 3</button>
                        <button type="button" class="btn btn-warning btn_sizes animate_rtl">Button 4</button>
                    </div>
                    <br/>
                    <br/>
                    <div class="btn-group">
