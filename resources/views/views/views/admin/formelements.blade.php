                    ...
                    <div class="panel-body auto_block">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <textarea placeholder="Write something here..." data-autogrow class="form-control resize_vertical autogrow_area" rows="3" cols="80" id="autogrow_area"></textarea>
                            </div>
                            <!-- /.input group -->
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <textarea placeholder="Write something here..." class="form-control pd-45 resize_vertical autogrow_area" rows="5" cols="80" id="autogrow_area"></textarea>
                            </div>
                            <!-- /.input group -->
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <textarea placeholder="Write something here..." class="form-control scroll pd resize_vertical autogrow_area" rows="5" cols="80" id="autogrow_area"></textarea>
                            </div>
                            <!-- /.input group -->
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <div class="span4">
                                    <textarea id="text_auto" placeholder="Write something here..." class="form-control display-no autogrow_area resize_vertical" data-autogrow rows="3" cols="80"></textarea>
