...
<section class="content-header">
            ...
            <section class="content">
                <div class="row web-mail">
                    <div class="col-lg-2 col-md-3 col-sm-4 animate_rtl">
                        <div class="whitebg">
                            <ul>
                                <li class="compose">
                    ...
                    <div class="col-lg-10 col-md-9 col-sm-8 animate_rtl">
                        <div class="whitebg">
                            <table class="table table-striped table-advance">
                                    ...
                                    <tr>
                                        <th colspan="4">
                                            <div class="row no-padding">
                                                <div class="col-md-7 col-lg-9 col-xs-12 animate_rtl">
                                                    <div class="btn-group">
                                ...
                                <tbody>
                                    <tr>
                                        <td colspan="4">
                                            <div>
                                                <div class="col-md-2 col-lg-1 col-sm-2 col-xs-3 image_pull-right">
                                                    <a href="#">
                                    ...
                                    <tr>
                                        <td colspan="3" class="images">
                                            <div class="col-md-6 col-lg-3 col-sm-6 col-xs-8">
                                                ...
                                                <div class=" nopadmar">
                                                    <br>
                                                    <div class="col-md-3 col-sm-3 col-lg-3 col-xs-6 no-padding button_float_right">
                                                        <button type="button" class="btn btn-success btn-sm ">View</button>
                                                    </div>
                                                    <div class="col-md-6 col-sm-3 col-lg-6 col-xs-4 margin_left rm_padding_right">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="row">
                                                <div class="nopadmar">
                                                    <div class="col-xs-6 col-sm-4 no-padding col-md-3 col-lg-2 button_float_right">
                                                    ...
                                                    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2 no-padding button_float_right">
