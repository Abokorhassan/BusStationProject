...
@section('content')
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 right_float">
                <h2>Contact Form</h2>
                <!-- Notifications -->
                <div id="notific">
            ...
            <div class="col-md-6 col-sm-6 right_float" id="address_margt">
                <div class="media media-right">
                    ...
                    <div class="media-body">
                        ...
                        <address>
                            ...
                            <br><span class="ltr">3340 Providence Drive #565</span>
                            <br><span class="ltr">Anchorage, AK(Alaska)</span>
                ...
                <div class="media padleft10">
                    ...
                    <div class="media-body padbtm2">
                        <h4 class="media-heading">Telephone:</h4> <span class="direction">(703) 717-4200</span>
                        <br /> Fax:400 423 1456
                    </div>
                </div>
            </div>
