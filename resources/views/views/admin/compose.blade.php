                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="compose row">
                            <label class="col-xs-2 hidden-xs animate_rtl" for="to1">To:</label>
                            <input type="email" name="email" class="col-xs-9 animate_rtl" id="to1" placeholder="Email id"
                                   tabindex="1" required>
                            <div class="clear"></div>
                            <label class="col-xs-2 hidden-xs animate_rtl" for="to">Subject:</label>
                            <input type="text" name="email_sub" class="col-xs-9 animate_rtl" id="to" tabindex="1"
                                   placeholder="Subject">
                            <div class="clear"></div>
