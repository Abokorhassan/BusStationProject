                                    ...
                                    <div class="nav-tabs-custom">
                                        ...
                                        <div class="tab-content">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="span3" id="interface" style="width:220px;">
                                                            ...
                                                            <label class="checkbox">
                                                                <input type="checkbox" id="shadetog" class="custom-checkbox"/> &nbsp;<span class="direction">Use experimental shader (shade: true)</span>
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="tab-pane" id="tab_8" style="padding:10px;">
                                                <div class="col-lg-8 col-md-8 col-sm-8 animate_rtl">
