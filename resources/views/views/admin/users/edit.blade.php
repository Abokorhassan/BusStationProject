                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane" id="tab2" disabled="disabled">
                                                ...
                                                <div class="form-group {{ $errors->first('dob', 'has-error') }}">
                                                    <label for="dob" class="col-sm-2 control-label tab2_label">Date of Birth</label>
                                                    <div class="col-sm-10">
                                                ...
                                                <div class="form-group {{ $errors->first('pic_file', 'has-error') }}">
                                                    <label for="pic" class="col-sm-2 control-label tab2_label">Profile picture</label>
                                                    <div class="col-sm-10">
                                                ...
                                                <div class="form-group  {{ $errors->first('pic', 'has-error') }}">
                                                    <label for="bio" class="col-sm-2 control-label bio">Bio <small>(brief intro)</small></label>
                                                    <div class="col-sm-10">
                                            ...
                                            <div class="tab-pane" id="tab4" disabled="disabled">
                                                ...
                                                <div class="form-group {{ $errors->first('group', 'has-error') }}">
                                                    <label for="group" class="col-sm-2 control-label tab4_label">Group *</label>
                                                    <div class="col-sm-10">
