                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body" id="slim1">
                                <div class="row">
                                    ...
                                    <div class="row">
                                            <div class="col-lg-4 col-md-1 col-sm-2 col-xs-5 text-center animate_rtl" style="padding: 1em 0;
                                            ...
                                            <div class="col-lg-4 col-md-5 col-sm-4 col-xs-4 text-center animate_rtl" style="padding: 1em 0;
                                        ...
                                        <div class="row" style="margin-top:10px;">
                                            <h3 >xs Grid</h3>
                                            <div class="col-xs-5 text-center animate_rtl" style="padding: 1em 0;
                                                            background-color: #D9EDF7;
                                                            border: 1px solid #A0DEF2;border-radius: 1px;">
                                                <div>.col-xs-5</div>
                                            </div>
                                            <div class="col-xs-4 text-center animate_rtl" style="padding: 1em 0;
                                                    background-color: #DFF0D8;
                                                    border: 1px solid #A3E69E;border-radius: 1px;">
                                                <div>.col-xs-4</div>
                                            </div>
                                        ...
                                        <div class="row" style="margin-top:10px;">
                                            <h3 >sm Grid</h3>
                                            <div class="col-sm-2 text-center animate_rtl" style="padding: 1em 0;
                                                        background-color: #D9EDF7;
                                                        border: 1px solid #A0DEF2;border-radius: 1px;">
                                                <div>.col-sm-2</div>
                                            </div>
                                            <div class="col-sm-4 text-center animate_rtl" style="padding: 1em 0;
                                                background-color: #DFF0D8;
                                                border: 1px solid #A3E69E;border-radius: 1px;">
                                                <div>.col-sm-4</div>
                                            </div>
                                        ...
                                        <div class="row" style="...">
                                            <h3 >md Grid</h3>
                                            <div class="col-md-1 text-center animate_rtl" style="padding: 1em 0;
                                                          background-color: #D9EDF7;
                                                          border: 1px solid #A0DEF2;border-radius: 1px;">
                                                <div>.col-md-1</div>
                                            </div>
                                            <div class="col-md-5 text-center animate_rtl" style="padding: 1em 0;
                                                  background-color: #DFF0D8;
                                                  border: 1px solid #A3E69E;border-radius: 1px;">
                                                <div>.col-md-5</div>
                                            </div>
                                        ...
                                        <div class="row" style="margin-top:10px;">
                                            <h3 >lg Grid</h3>
                                            <div class="col-lg-4 text-center animate_rtl" style="padding: 1em 0;
                                                  background-color: #D9EDF7;
                                                  border: 1px solid #A0DEF2;border-radius: 1px;">
                                                <div>.col-lg-4</div>
                                            </div>
                        ...
                        <div class="col-md-12 ">
                            <div class="panel panel-success">
                                ...
                                <div class="panel-body" id="slim2">
                                    ...
                                    <!-- /.row -->
                                    <div class="row">
                                        <div class="col-lg-8 text-center animate_rtl">
                                            <div class="panel panel-primary">
                                    ...
                                    <!-- /.row -->
                                    <div class="row">
                                        <div class="col-lg-3 text-center animate_rtl">
                                            <div class="panel panel-primary ">
                                                <div class="panel-body">.col-lg-3</div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 text-center animate_rtl">
                                            <div class="panel panel-primary ">
                                                <div class="panel-body">.col-lg-6</div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-2 text-center animate_rtl">
                                            <div class="panel panel-primary">
                                                <div class="panel-body">.col-lg-2</div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-1 text-center animate_rtl">
                                            <div class="panel panel-primary">
                                                <div class="panel-body">.col-lg-1</div>
                                            </div>
                                        </div>
