                    ...
                    @if($role)
                        {!! Form::model($role, ['url' => URL::to('admin/groups/'. $role->id), 'method' => 'put', 'class' => 'form-horizontal']) !!}
                            ...
                            <div class="form-group {{ $errors->
                                ...
                                <label for="title" class="col-sm-2 control-label animate_rtl left_label">
                                    @lang('groups/form.name')
                                </label>
                                <div class="col-sm-5 animate_rtl">
                            ...
                            <div class="form-group">
                                <label for="slug" class="col-sm-2 control-label animate_rtl left_label">@lang('groups/form.slug')</label>
                                <div class="col-sm-5 animate_rtl">
