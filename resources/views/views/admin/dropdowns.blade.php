                    ...
                    <div class="panel-body">
                                ...
                                <select id="select24" class="form-control">
                                    ...
                                    <optgroup label="Eastern Time Zone">
                                        ...
                                        <span class="input-group-btn">
                                            <button class="btn btn-default search_btn" type="button" data-select2-open="single-append-text">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group select2-bootstrap-prepend">
                                        <span class="input-group-btn">
                                            <button class="btn btn-default rtl_search" type="button" data-select2-open="single-prepend-text">
                                                <span class="glyphicon glyphicon-search"></span>
                                            </button>
                                        </span>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group select2-bootstrap-append">
                                ...
                                <div class="input-group-btn">
                                    ...
                                    <button type="button" class="btn btn-default dropdown-toggle action_btn" data-toggle="dropdown">
                                        Action
