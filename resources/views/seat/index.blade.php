            ...
            <div class="row">
                <div class="content">
                    <div class="col-md-8 right_float ">
                        @forelse ($seats->chunk(3) as $collection)
                            @foreach ($collection as $seat)
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                ...
                                                                <a style="margin-left: 5em; " href="{{ URL::to('seat/' .$seat->id .'/edit') }}">
                                                            ...
                                                            <div class="col-sm-6">
                                                                ...
                                                                <p class="additional-post-wrap">
                                                                    <span style="margin-right: -15%" class="additional-post">
                                                                        ...
                                                                        <a href="#"> {{$seat->created_at->diffForHumans()}} 
                                                                        </a>
                                                                    </span>
                                                                </p>
                                                                <a style="color: white; margin-left: -2em;" href="javascript:;" data-toggle="modal" onclick="deleteData({{$seat->id}})" 
                                    ...
                                    <div  class="modal fade" id="delete_confirm" tabindex="-1" role="dialog" aria-labelledby="user_delete_confirm_title" aria-hidden="true">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <h5>You sure, you want to DELETE This Seat?</h5>
                                            </div>
                            ...
                            @endforeach
                                ...
                                <!-- END FEATURED POST -->
                        @empty
                        <h3>No Seat On your collections!
                        </h3>
...
@section('footer_scripts')
    ...
    <script type="text/javascript">
        function deleteData(id){
            var id = id;
            var url = '{{ route("user.seat.destroy", ":id") }}';
