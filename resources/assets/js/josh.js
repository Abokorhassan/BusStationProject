...
$('html[dir=rtl] .sidebar .sub-menu').find('.fa').removeClass('fa-angle-double-right').addClass('fa-angle-double-left');
$('html[dir=rtl] #back-to-top').attr('data-placement','right');