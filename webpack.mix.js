...
mix.copy(resourcesAssets + 'css/bootstrap-wysihtml5-rtl.css', destCss);

// Fixed menu layout
mix.sass( srcCss + 'rtl_custom.scss', destCss );
mix.sass( srcCss + 'rtl_minisidebar.scss', destCss );
mix.sass( srcJs + 'rtl_custom.js', destJs );

//RTL frontend

mix.sass( srcCss + 'rtl_frontend.scss', destCss + 'frontend/rtl_frontend.css');


// mix.sass( srcCss + 'bootstrap-wysihtml5-rtl.css', destCss );
// mix.sass(srcSass + 'app.scss', 'public/css/rtl_custom.css');
...
mix.combine(
    [
        ...
        // srcCss + 'bootstrap-wysihtml5-rtl.css',
        destCss + 'rtl_custom.css',
        destCss + 'rtl_minisidebar.css',
        destCss + 'frontend/rtl_frontend.css'
    ], destCss + 'app.css');
